...
from src.tidal_cleanup.models.models import Track, Playlist
...
class TestTrackComparisonService:
    ...
    def test_fuzzy_matching(self):
        ...
        result = self.service.find_best_match(
            "Beatles - Hey Jude", candidates
        )
...
class TestTidalService:
    ...
    def test_connection_success(self, mock_session_class, tmp_path):
        ...
        token_file.write_text('{"token_type": "Bearer", "access_token": "test", "refresh_token": "test"}')
