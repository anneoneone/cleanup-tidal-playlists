...
class TidalCleanupApp:
    ...
    def sync_playlists(self) -> bool:
        ...
        try:
            ...
            console.print(f"[green]✓[/green] Processed {processed}/{len(playlists)} playlists")
    ...
    def _convert_files(self):
        ...
        console.print(f"[green]✓[/green] Conversion complete: {successful} successful, {failed} failed")
    ...
    def generate_rekordbox_xml(self) -> bool:
        ...
        try:
            ...
            if not self.rekordbox_service.validate_input_folder(self.config.rekordbox_input_folder):
                console.print("[red]✗[/red] Invalid input folder for Rekordbox generation")
                return False
            ...
            console.print(f"[green]✓[/green] Rekordbox XML generated: {self.config.rekordbox_output_file}")
            return True
