...
class PlaylistNameParser:
    ...
    def parse_playlist_name(self, playlist_name: str) -> PlaylistMetadata:
        ...
        for emoji in emojis:
            if emoji in self.emoji_to_group_tag:
                group, tag_name = self.emoji_to_group_tag[emoji]
    ...
    def _extract_emojis(self, text: str) -> List[str]:
        ...
        """
        # Unicode ranges for emojis including flag sequences
        emoji_pattern = re.compile(
            "(?:"
            "[\U0001f1e0-\U0001f1ff]{2}|"  # flag sequences (2 regional indicators)
