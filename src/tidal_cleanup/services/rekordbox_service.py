...
from ..models.models import Track, FileInfo
...
class RekordboxService:
    ...
    def generate_xml(
        ...
        try:
            ...
            logger.info(
                f"Successfully generated Rekordbox XML: {output_file}"
            )
            logger.info(
    ...
    def validate_input_folder(self, folder_path: Path) -> bool:
        ...
        has_playlists = any(
            item.is_dir() for item in folder_path.iterdir()
        )
